...
import lq2007.mcmod.isaacformc.common.network.NetworkRegister;
...
public class Isaac {
    ...
    public Isaac() {
        ...
        if (FMLEnvironment.dist.isClient()) {
            proxy = new lq2007.mcmod.isaacformc.client.ClientProxy(eventBus);
        } else {
        ...
        TILES = REGISTER.add(new TileEntityRegister(REGISTER, "lq2007.mcmod.isaacformc", this::getBlocks));
    ...
    private Block[] getBlocks(Class<? extends TileEntity> aClass) {
        ...
        try {
            String blockClassName = "lq2007.mcmod.isaacformc.common.block." + blockName;
